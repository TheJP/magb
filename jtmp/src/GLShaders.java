...
public class GLShaders
{
    ...
    static int loadShaders(GL2 gl,                             // Compile and Link Vertex- and Fragmentshader
    ...
    static public String printShaderInfoLog(GL2 gl, int obj)
    ...
    static public String printProgramInfoLog(GL2 gl, int obj)
    {  // get the GL info log
    ...
    static public int getProgramParameter(GL2 gl, int obj, int paramName)
    {  final int params[] = new int[1];
